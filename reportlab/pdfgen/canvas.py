...
class NumberedCanvas(Canvas):
    ...
    def save(self):
        ...
        for state in self._saved_page_states:
            ...
            if self.alignment == 'LEFT' or '' or None:
                function = self.drawString
            if self.alignment == 'RIGHT':
                function = self.drawRightString
            if self.alignment == 'CENTRED':
                function = self.drawCentredString

            function(self.x, self.y,"%(this)i/%(total)i" % { 
                'this': self._pageNumber,
                'total': self._pageCount,
                }   
                )   
